...
export function DashboardPage() {
  ...
  return (
    <div>
      <PageHeader title="Обзор" description="Текущие действия, требующие внимания оператора." actions={<><Link className="btn btn-ghost" to="/onboarding">Новый сайт</Link><Link className="btn" to="/sites">Сайты</Link></>} />
