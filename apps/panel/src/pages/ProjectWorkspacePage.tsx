    ...
    <div aria-busy={busy !== null}>
      ...
      <Surface title="4.1. AI-черновик текста и SEO">
        ...
        <div className="stack">
          ...
          {aiQuote && <div className="surface"><strong>Предварительная оценка: ${aiQuote.estimated_cost_usd.toFixed(6)}</strong><p className="muted">Лимит ${aiQuote.max_cost_usd.toFixed(6)} · источник {aiQuote.pricing_source} · тариф на {aiQuote.pricing_observed_at}. Дневной/30-дневный бюджет — preflight-проверка, не атомарное резервирование; для жёсткого ограничения нужен spending cap у провайдера.</p></div>}
